...
export const navigationItems = [["Overview", ""], ["Events", "events"], ["Dead Letters", "dead-letters"], ["Queue", "queue"], ["Apps", "apps"], ["Routing Rules", "routing-rules"], ["Realtime Studio", "realtime-studio"], ["Audit Logs", "audit-logs"], ["System", "system"]] as const;
