...
manifest=['README.md','user.md','user/getting-started.md','user/faq.md','developer.md','developer/README.md','developer/registration-flow.md','developer/auth.md','developer/api-overview.md','developer/reliability.md','developer/websocket.md','developer/functions.md','deploy/README.md','api.md','security.md','troubleshooting.md','skills.md','developer/skills.md','skills/relayhub-integration/SKILL.md','skills/relayhub-integration/references/authentication.md']
...
resources=['openapi.json','schemas/event-envelope.schema.json','schemas/client-frame.schema.json','schemas/server-frame.schema.json','skills/relayhub-integration/references/openapi.json','skills/relayhub-integration.zip','llms.txt']
