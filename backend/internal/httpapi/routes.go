...
var routeAuth = map[string]string{
	...
	"GET /": "public", "GET /admin": "public", "GET /admin/*": "public", "GET /ws": "ws_token",
	"GET /assets/*": "public", "GET /img/*": "public", "GET /user/*": "public", "GET /developer/*": "public", "GET /control-panel/*": "public",
	"GET /developer/queue-v2": "public", "GET /developer/realtime-v2": "public",
	"GET /api/open-api-overview": "public", "GET /api/signature-and-streaming": "public",
	"GET /skills/*": "public", "GET /sdk": "public", "GET /sdk/relayhub-integration.zip": "public", "GET /schemas/*": "public", "GET /asyncapi.yaml": "public",
	"GET /docs": "public", "GET /docs/*": "public", "GET /openapi.json": "public", "GET /llms.txt": "public", "GET /llms-full.txt": "public",
	"GET /api/v1/stream":         "ws_token",
	"POST /api/v1/admin/session": "public", "GET /api/v1/admin/session": "admin_session", "DELETE /api/v1/admin/session": "admin_session",
	...
	"GET /api/v1/admin/audit": "admin", "POST /api/v1/admin/users": "admin",
